...
int main() {
    cout << endl;
    AssistantProfessor* prof1 = new AssistantProfessor("Rachna", 30, "P001", "rachna@uni.com", "Computer Science", "2020-08-15", "05 may 2025");
    AssociateProfessor* prof2 = new AssociateProfessor("kartik", 35, "P002", "kartik@uni.com", "Physics", " 22 july 2015", "Evloution of psyhics");

    UndergraduateStudent u1("Kabir", 20, "001", "kabir@mail.com", "1 june 2022", "Computer Science", "Software Engineering", "AI", "1 may 2025");
    GraduateStudent g1("Karan", 24, "002", "karan@mail.com", "29 february 2020", "Computer Science", "Internet networks", "Computer Networking", "Dr.karan");
